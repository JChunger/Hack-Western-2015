...
<html lang="en">
	...
	<div style="margin-top: 10%;" class="container">
	    <div class="row">
               <?php
                $gnore = $odb -> prepare("SELECT * FROM `services` WHERE city = :city AND closed = 0");
                $gnore -> execute(array(":city" => $_SESSION['city']));
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                      <div class="caption">
                        ...
                        <p><a href="#" class="btn btn-primary" role="button">Request!</a></p>
                      </div>
                    </div>
                  </div>
            <?php } ?>
